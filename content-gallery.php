...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
  ...
  <div class="entry-content">
    <?php if ( post_password_required() ) : ?>
      <?php the_content( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'jewel' ) ); ?>
      ...
      <?php else : ?>
        ...
        <p><em><?php printf( _n( 'This gallery contains <a %1$s>%2$s photo</a>.', 'This gallery contains <a %1$s>%2$s photos</a>.', $total_images, 'jewel' ),
            'href="' . get_permalink() . '" title="' . sprintf( esc_attr__( 'Permalink to %s', 'jewel' ), the_title_attribute( 'echo=0' ) ) . '" rel="bookmark"',
